...
function formDisplayHandler(e) {
    if(e.target.value == "anulacion") {
        document.querySelector(".payment-reference").classList.remove("hide");
        document.querySelector(".twofactor").classList.add("hide");
    }
    else if(e.target.value == "compra") {
        document.querySelector(".twofactor").classList.remove("hide");
        document.querySelector(".payment-reference").classList.add("hide");
    }
    else {
        document.querySelector(".payment-reference").classList.add("hide");
        document.querySelector(".twofactor").classList.add("hide");
...
export { displayBack, displayJsonInfo, displayResponse, displayForm, formDisplayHandler };