...
function displayBack() {
    ...
    document.querySelector("#scp").classList.remove("d-none");
}
...
function displayResponse(rq, rs) {
    ...
    if(rs.hasOwnProperty("error_list") || rs.hasOwnProperty("code") || rs.hasOwnProperty("httpCode")) {
        ...
        document.querySelector(".transaction-response p").innerText = "Se ha generado un error al intentar generar su solicitud";
    }
    else {
        document.querySelector(".transaction-response h2").innerText = "Solicitud exitosa";
